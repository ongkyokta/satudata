  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (i = 0; i < data.length; i++) {
        ...
        var jumTotSekolahBaik = data[i].jumTotSekolahBaik;
        var jumTotSekolahRingan = data[i].jumTotSekolahRingan;
        var jumTotSekolahSedang = data[i].jumTotSekolahSedang;
        var jumTotSekolahBerat = data[i].jumTotSekolahBerat;
      ...
      if (jumTotRuangan >= 1) {
        var PruangBaik = ((jumTotSekolahBaik / jumTotSekolah) * (100)).toFixed(2);
        var PruangRingan = ((jumTotSekolahRingan / jumTotSekolah) * (100)).toFixed(2);
        var PruangSedang = ((jumTotSekolahSedang / jumTotSekolah) * (100)).toFixed(2);
        var PruangBerat = ((jumTotSekolahBerat / jumTotSekolah) * (100)).toFixed(2);
      ...
      $("#areastatistikSarana").html(
        ...
        'aria-valuemax="100"><span class="mt-n4 text-900">' + formatRibuan(jumTotSekolahBaik.toString()) + ' - ' + PruangBaik + ' %</span></div>' +
        ...
        'aria-valuemax="100"><span class="mt-n4 text-900">' + formatRibuan(jumTotSekolahRingan.toString()) + ' - ' + PruangRingan + ' %</span></div>' +
        ...
        'aria-valuemax="100"><span class="mt-n4 text-900">' + formatRibuan(jumTotSekolahSedang.toString()) + ' - ' + PruangSedang + ' %</span></div>' +
        ...
        'aria-valuemax="100"><span class="mt-n4 text-900">' + formatRibuan(jumTotSekolahBerat.toString()) + ' - ' + PruangBerat + ' %</span></div>');
...
function ambilmarkerwisata() {
  $.ajax({
    url: "aksi/ambil_marker_pendidikan.php",
    dataType: "json",
    method: "POST",
    success: function (data) {
       ...
       */
        if (data[i].bentuk == "TK") {
          var marker = L.circleMarker([words2[0], words2[1]], {
            ...
            '</tr>' +
            '<tr>' +
            '<td style="vertical-align: top;">NPSN</td><td style="vertical-align: top;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="vertical-align: top;">' + data[i].npsn + '</td>' +
            '</tr>' +
            '<tr>' +
            ...
            '</tr>' +
            '<tr>' +
            '<td style="vertical-align: top;">Kabupaten</td><td style="vertical-align: top;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="vertical-align: top;">' + "Jember" + '</td>' +
            '</tr>' +
            '<tr>' +
            '<td style="vertical-align: top;">Propinsi</td><td style="vertical-align: top;">&nbsp;&nbsp;:&nbsp;&nbsp;</td><td style="vertical-align: top;">' + "Jawa Timur" + '</td>' +
            '</tr>' +
            '<tr>' +
            ...
            '<br><br><center><button class="btn btn-sm btn-falcon-default rounded-pill cmdMapDetail" type="button" data-id = ' + data[i].idtempat + '>Tampilkan Detail Sekolah</button></center>'
          ).addTo(wisatalayer)
          marker.setRadius(8);
...
$("#lv_kota").click(function () {
  ...
  $("#area-halaman-media").fadeOut("slow");
