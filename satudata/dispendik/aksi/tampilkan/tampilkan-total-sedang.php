...
<div class="modal-header px-4 position-relative modal-shape-header bg-shape">
    <div class="position-relative z-index-1 light">
        <h5 class="mb-0 text-white">Sekolah Kondisi Rusak Sedang</h5>
        <p class="fs--1 mb-0 text-white">Data Sekolah Sarana dan Ruang Kondisi Rusak Sedang <?php echo $namawilayah ?></p>
    </div>
...
<div class="modal-body py-3">
    ...
    <div class="table-responsive scrollbar mb-3">
        <table id="tabel-total-sedang" class="table table-sm table-striped mb-0 fs--1 w-100">
            <thead class="bg-200">
                <tr>
            ...
            <tbody class="bg-white" id="list-tabel-total-sedang">
...
if ($ketwilayah == "kota"){
    $sqlx = ("SELECT id,nama,alamat_jalan,guru,siswa,bentuk_pendidikan,lintang,bujur
      ...
      asrama_siswa_rusak_sedang>0
		...
		OR ruang_kelas_rusak_sedang>0");
} else if ($ketwilayah == "kecamatan"){
    $sqlx = ("SELECT id,nama,alamat_jalan,guru,siswa,bentuk_pendidikan,lintang,bujur
      FROM tbl_api_dispendik
      WHERE 
      asrama_siswa_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR tempat_ibadah_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR wc_guru_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR wc_siswa_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR wc_umum_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR laboratorium_bahasa_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR laboratorium_ipa_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR laboratorium_ips_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR laboratorium_komputer_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR laboratorium_multimedia_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR ruang_bina_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR ruang_guru_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR ruang_kepala_sekolah_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR ruang_perpustakaan_rusak_sedang>0 AND id_kecamatan = '".$idwilayah."'
		OR ruang_kelas_rusak_sedang>0
        AND id_kecamatan = '".$idwilayah."'");
} else if ($ketwilayah == "desa"){
    $sqlx = ("SELECT id,nama,alamat_jalan,guru,siswa,bentuk_pendidikan,lintang,bujur
      FROM tbl_api_dispendik
      WHERE 
      asrama_siswa_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR tempat_ibadah_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR wc_guru_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR wc_siswa_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR wc_umum_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR laboratorium_bahasa_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR laboratorium_ipa_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR laboratorium_ips_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR laboratorium_komputer_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR laboratorium_multimedia_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR ruang_bina_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR ruang_guru_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR ruang_kepala_sekolah_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR ruang_perpustakaan_rusak_sedang>0 AND id_desa = '".$idwilayah."'
		OR ruang_kelas_rusak_sedang>0
...
$(document).ready(function() {
    ...
    var dataTable = $("#tabel-total-sedang").dataTable({
        "paging": true,
...
$('#list-tabel-total-sedang').on('click', '.btnTampilMapCari', function() {
...
$('#list-tabel-total-sedang').on('click', '.btnTampilDetailCari', function() {
