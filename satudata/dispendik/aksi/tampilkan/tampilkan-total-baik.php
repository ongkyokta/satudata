...
<div class="modal-header px-4 position-relative modal-shape-header bg-shape">
    <div class="position-relative z-index-1 light">
        <h5 class="mb-0 text-white">Sekolah Kondisi Baik</h5>
        <p class="fs--1 mb-0 text-white">Data Sekolah Sarana dan Ruang Kondisi Baik <?php echo $namawilayah ?></p>
    </div>
...
if ($ketwilayah == "kota"){
    $sqlx = ("SELECT id,nama,alamat_jalan,guru,siswa,bentuk_pendidikan,lintang,bujur
      ...
      WHERE 
        asrama_siswa_rusak_ringan=0 AND asrama_siswa_rusak_sedang=0 AND asrama_siswa_rusak_berat=0
		...
		AND ruang_kelas_rusak_ringan=0 AND ruang_kelas_rusak_sedang=0 AND ruang_kelas_rusak_berat=0");
...
$('#list-tabel-total-sekolah').on('click', '.btnTampilMapCari', function() {
...
$('#list-tabel-total-sekolah').on('click', '.btnTampilDetailCari', function() {
