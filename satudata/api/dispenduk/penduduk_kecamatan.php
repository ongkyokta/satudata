...
//    $sql2  = "INSERT INTO tbl_api_dispenduk_kecamatan (kecamatan,jml_penduduk,jml_laki,jml_perempuan,id_kecamatan) 
 //                 VALUES ('".$val['NAMAKEC']."','".$val['JUMLAH']."','".$val['LAKI']."','".$val['PEREMPUAN']."','".$val['NO_KEC']."')";
...
$a=array('jmlperempuan'=>number_format($totP,0,",","."),'jmllaki'=>number_format($totL,0,",",".")
,'jmltotal'=>number_format($total,0,",","."));
$items[] = $a;
