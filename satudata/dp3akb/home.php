...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM dp3akb_kekerasan");
        ...
        <div class="container-fluid" data-layout="container">
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM dp3akb_kekerasan GROUP BY tahun DESC");
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-calendar'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama = mysqli_query($dbconn, "SELECT * FROM dp3akb_kekerasan GROUP BY id_kecamatan ASC");
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $submenu = mysqli_query($dbconn, "SELECT DISTINCT tahun AS tahunnya FROM dp3akb_kekerasan WHERE id_kecamatan = '" . $idkec . "' GROUP BY tahun ASC");
                                ...
                                while($sub = mysqli_fetch_array($submenu)){
                                        ...
                                        echo " <li class='nav-item'>
                                                    <a class='nav-link lv_desa' href='#!' data-idkec='$idkec' data-tahun='$tahun' data-keterangan='desa' data-nmkecamatan='$nmkecamatan' data-bs-toggle='' aria-expanded='false'>
                                                        <div class='d-flex align-items-center'><span class='nav-link-text ps-1'><span class='fas fa-calendar me-2'></span>$tahun</span>
                                                        </div>
                                                    </a>
                                                </li>"; 
                                    } 
            ...
            <div class="content">
                ...
                <div id="area-halaman">
                                ...
                                <div class="row gx-0 flex-between-center">
                                    <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2" src="../assets/img/illustrations/crm-bar-chart.png" alt="" width="90" />
                                        <div>
                                            ...
                                            <h5 class="text-primary fw-normal mb-0"><?php echo $nmcabang; ?></h5>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Keluarga Berencana <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data DP3AKB <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body pt-0">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahKBAktif"></h4>
                                            <p class="fs--1 text-600 mb-0">Peserta KB Aktif</p>
                                        </div>
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-success" id="lbljumlahKBBaru"></h4>
                                            <p class="fs--1 text-600 mb-0">Peserta KB Baru</p>
                                        </div>
                                        <div class="col-4 border-200">
                                            <h4 class="mb-0 text-danger" id="lbljumlahKekerasan"></h4>
                                            <p class="fs--1 text-600 mb-0">Korban Kekerasan Perempuan & Anak</p>
                                        </div>
                                    </div>

                                    <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikKB" style="height: 6px;">
                                    </div>
                                    <h6 class="fs--1 mb-2 mt-3">Prosentase Tingkat Pertumbuhan <span id="lblkopperbandinganarea"></span></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Peserta KB Aktif Metode dan Kontrasepsi</p>
                                    </div>
                                    <div class="chart h-100" id="hitungKBAktifChart" data-echart-responsive="true">
                                        <canvas id="KBAktifChart" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Total KB Aktif Metode dan Kontrasepsi</p>
                                    </div>
                                    <div class="chart h-100" id="hitungKBAktifTotalPie" data-echart-responsive="true">
                                        <canvas id="KBAktifTotalPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Peserta KB Baru Metode dan Kontrasepsi</p>
                                    </div>
                                    <div class="chart h-100" id="hitungKBBaruChart" data-echart-responsive="true">
                                        <canvas id="KBBaruChart" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Total KB Baru Metode dan Kontrasepsi</p>
                                    </div>
                                    <div class="chart h-100" id="hitungKBBaruTotalPie" data-echart-responsive="true">
                                        <canvas id="KBBaruTotalPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="halaman-area-pengaduan" style="display:none">
                        <div class="row mb-3 g-3">
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header d-flex flex-between-center">
                                        <h6 class="mb-0">Statistik Data Pengaduan <span class="lblkoparea"></span>
                                        </h6>
                                    </div>
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-3 border-end border-200">
                                                <h4 class="mb-0 text-danger" id="lbljumlahAduAnak"></h4>
                                                <p class="fs--1 text-600 mb-0">Pengaduan Anak</p>
                                            </div>
                                            <div class="col-3 border-end border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahSelesaiAnak"></h4>
                                                <p class="fs--1 text-600 mb-0">Penyelesaian Pengaduan Anak</p>
                                            </div>
                                            <div class="col-3 border-end border-200">
                                                <h4 class="mb-0 text-danger" id="lbljumlahAduPerempuan"></h4>
                                                <p class="fs--1 text-600 mb-0">Pengaduan Perempuan</p>
                                            </div>
                                            <div class="col-3 border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahSelesaiPerempuan"></h4>
                                                <p class="fs--1 text-600 mb-0">Penyelesaian Pengaduan Perempuan</p>
                                            </div>
                                        </div>
                                        
                                        <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikPengaduan" style="height: 6px;">
                                        </div>
                                        <h6 class="fs--1 mb-2 mt-3">Prosentase Tingkat Pertumbuhan <span id="lblkopperbandinganPengaduan"></span></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Pengaduan dan Penyelesaian Anak</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPengaduanAnak" data-echart-responsive="true">
                                            <canvas id="pengaduanAnakChart" height="200px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Pengaduan dan Penyelesaian Perempuan</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPengaduanPerempuan" data-echart-responsive="true">
                                            <canvas id="pengaduanPerempuanChart" height="200px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
