...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM diskop");
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM diskop GROUP BY tahun DESC");
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-calendar'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                            ...
                            <li class="nav-item">
                                ...
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $submenu = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM diskop WHERE id_kecamatan = '" . $idkec . "' ORDER BY tahun DESC");
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Koperasi <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Dinas Koperasi <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-4">
                                        <div class="col-3 border-end border-200">
                                            ...
                                            <p class="fs--1 text-600 mb-0">Jumlah Usaha Mikro</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0 text-danger" id="lbljumlahpelanggan"></h4>
                                            <p class="fs--1 text-600 mb-0">Jumlah Koperasi</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                        ...
                                        <div class="col-3 border-200">
                                            ...
                                            <p class="fs--1 text-600 mb-0">Jumlah Karyawan</p>
                                        </div>
                                    </div>

                                    <div class="row mt-3 mb-4">
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0 text-secondary" id="lbljumlahmodal"></h4>
                                            <p class="fs--1 text-600 mb-0">Modal</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahvolusaha"></h4>
                                            <p class="fs--1 text-600 mb-0">Volume Usaha</p>
                                        </div>
                                        <div class="col-3 border-200">
                                            <h4 class="mb-0 text-secondary" id="lbljumlahshu"></h4>
                                            <p class="fs--1 text-600 mb-0">Sisa Hasil Usaha</p>
                                        </div>
                                    </div>

                                    <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikdiskop" style="height: 6px;">
                                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Usaha Mikro - Koperasi</p>
                                    </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Kondisi Koperasi</p>
                                    </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Anggota - Karyawan</p>
                                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Modal - Usaha - SHU</p>
                                    </div>
                                    <div class="chart h-100" id="hitungModalChart" data-echart-responsive="true">
                                        <canvas id="ModalChart" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Volume Usaha - SHU</p>
                                    </div>
                                    <div class="chart h-100" id="hitungSHUPie" data-echart-responsive="true">
                                        <canvas id="SHUPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
