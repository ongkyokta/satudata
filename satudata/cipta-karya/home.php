...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM cipta_karya");
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $nmkecamatan = ucwords(strtolower($dm['kecamatan']));
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Dinas PU Cipta Karya <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Dinas PU Cipta Karya <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-0">
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahrumahlayak"></h4>
                                            <p class="fs--1 text-600 mb-0">Rumah Layak Huni</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahairbersih"></h4>
                                            <p class="fs--1 text-600 mb-0">KK Memperoleh Air Bersih</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahjamban"></h4>
                                            <p class="fs--1 text-600 mb-0">KK Memiliki Jamban</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahtaman"></h4>
                                            <p class="fs--1 text-600 mb-0">Luas Taman</p>
                                        </div>
                                        <div class="col-2 border-200">
                                            <h4 class="mb-0 text-warning" id="lbljumlahlampu"></h4>
                                            <p class="fs--1 text-600 mb-0">Titik Lampu</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Rumah Layak Huni - 10 Tahun Terakhir</p>
                                    </div>
                                    <div class="chart h-100" id="hitungRumahLayakChart" data-echart-responsive="true">
                                        <canvas id="rumahlayakChart" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Jumlah KK Memperoleh Air Bersih - 10 Tahun Terakhir</p>
                                    </div>
                                    <div class="chart h-100" id="hitungAirMinumChart" data-echart-responsive="true">
                                        <canvas id="airminumChart" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Jumlah KK Memiliki Jamban - 10 Tahun Terakhir</p>
                                    </div>
                                    <div class="chart h-100" id="hitungJambanChart" data-echart-responsive="true">
                                        <canvas id="jambanChart" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Luas Taman - 10 Tahun Terakhir</p>
                                    </div>
                                    <div class="chart h-100" id="hitungTamanChart" data-echart-responsive="true">
                                        <canvas id="tamanChart" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Jumlah Titik Lampu - 10 Tahun Terakhir</p>
                                    </div>
                                    <div class="chart h-100" id="hitungLampuChart" data-echart-responsive="true">
                                        <canvas id="lampuChart" height="300px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
