...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM perumda_kahyangan");
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama = mysqli_query($dbconn, "SELECT kebun FROM perumda_kahyangan GROUP BY kebun ASC");
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    $idkec = $dm['kebun'];
                                    $idkec2 = "ID" . str_replace(".", "", $idkec);
                                    $nmkecamatan = ucwords(strtolower($dm['kebun'])); 
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Perusahaan Umum Daerah Kahyangan - <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-0">
                                        <div class="col-4 border-end border-200">
                                            ...
                                            <p class="fs--1 text-600 mb-0">Karet</p>
                                        </div>
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-warning" id="lbljumlahpelanggan"></h4>
                                            <p class="fs--1 text-600 mb-0">Kopi</p>
                                        </div>
                                        <div class="col-4 border-200">
                                            <h4 class="mb-0 text-secondary" id="lbljumlahpenjualan"></h4>
                                            <p class="fs--1 text-600 mb-0">Cengkeh</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-6 px-xxl-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Hasil Perkebunan</p>
                                    </div>
