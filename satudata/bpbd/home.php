        ...
        <div class="container-fluid" data-layout="container">
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            <li class="nav-item">
                                <!-- parent pages--><a class="nav-link active" id="lv_kota" data-nama="Kabupaten Jember"
                                    ...
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                            ...
                                            class="nav-link-text ps-1">Sebaran Bencana</span>
                                    </div>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <?php
              $menuutama = mysqli_query($dbconn, "SELECT * FROM tbl_api_bpbd GROUP BY id_kecamatan ASC");
              while($dm = mysqli_fetch_array($menuutama)){
				...
				$submenu = mysqli_query($dbconn, "SELECT * FROM tbl_api_bpbd WHERE id_kecamatan = '".$idkec."' GROUP BY desa ASC");
            ...
            <div class="content">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Rawan Bencana <span class="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Ancaman Bencana</p>
                                    </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Sebaran Terdampak</p>
                                    </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Penduduk Rawan Bencana <span class="lblkoppeta"></span></h6>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahpenduduk"></h4>
                                            <p class="fs--1 text-primary mb-0">Total Penduduk</p>
                                        </div>
                                        <div class="col-3 border-end border-200">
                                            <h4 class="mb-0 text-danger" id="lbljumlahrawan"></h4>
                                            <p class="fs--1 text-danger mb-0">Rawan Bencana</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahpenerima"></h4>
                                            <p class="fs--1 text-600 mb-0">Penerima Layanan</p>
                                        </div>
                                    </div>
                                    <div class="overflow-visible progress mt-4 rounded-3" id="areastatistikSarana"
                                        style="height: 6px;">
                                    </div>
                                    <p class="fs--1 mb-2 mt-3">Prosentase jumlah penduduk, rawan bencana dan penerima layanan
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <!---------------- tabel FADWAL ------------------>
                <div class="row mb-3 mt-3 g-3" id="area-jadwal" style="display:none">
                            ...
                            <div class="card-header">
                                <div class="row flex-between-center">
                                    <div class="col-sm-auto d-flex align-items-center pe-0">
                                        <h6 class="mb-0 text-nowrap py-2 py-xl-0">Data Penduduk Rawan Bencana <span
                                                class="lblkoppeta"></span></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body bg-light px-3 py-3">
                                <div class="table-responsive scrollbar">
                                    <table id="tabeljadwal" class="table table-striped table-sm mb-0 fs--1 w-100">
                                        <thead class="bg-200">
                                            <tr>
                                                <th class="sort text-center">Nama Area</th>
                                                <th class="sort text-center">Laki-Laki</th>
                                                <th class="sort text-center">Perempuan</th>
                                                <th class="sort text-center">Penduduk</th>
                                                <th class="sort text-center">Rawan</th>
                                                <th class="sort text-center">Penerima</th>
                                                <th class="sort text-center">Ancaman</th>
                                            </tr>
                                        </thead>
