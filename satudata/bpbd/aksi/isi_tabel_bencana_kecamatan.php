...
$sqlx = ("SELECT DISTINCT id_desa,desa FROM tbl_api_bpbd WHERE id_kecamatan='".$idkecamatan."'");
...
while($t=mysqli_fetch_array($result)){
	...
	FROM tbl_api_bpbd WHERE id_desa='".$t['id_desa']."'");
	$result2 = mysqli_query($dbconn,$sqlx2);
	$c= mysqli_fetch_assoc($result2);

	$sqlx3 = ("SELECT DISTINCT ancaman_bahaya FROM tbl_api_bpbd WHERE id_desa='".$t['id_desa']."'");
