...
// cipta karya //
$qri6 = ("SELECT SUM(jml_kk_layak) AS jmlsanitasi,SUM(jml_babs) AS jmlbabs FROM tbl_api_cipta_sanitasi");
$dbqri6 = mysqli_query($dbconn, $qri6);
$f = mysqli_fetch_assoc($dbqri6);
$jmlsanitasi = number_format($f['jmlsanitasi'], 0, ",", ".");
$jmlbabs = number_format($f['jmlbabs'], 0, ",", ".");

$qri6a = ("SELECT SUM(jml_sr) AS jmlsr,SUM(jml_sr_pdam) AS jmlpdam FROM tbl_api_cipta_air");
$dbqri6a = mysqli_query($dbconn, $qri6a);
$f1 = mysqli_fetch_assoc($dbqri6a);
$jmlsr = number_format($f1['jmlsr'], 0, ",", ".");
$jmlpdam = number_format($f1['jmlpdam'], 0, ",", ".");
mysqli_free_result($dbqri6);
mysqli_free_result($dbqri6a);
...
<body style="-webkit-user-select:none;-moz-user-select:none;">
    ...
    <main class="main" id="top">
            ...
            <div class="container">
                ...
                <div class="row flex-center mt-4">
                    <div class="col-lg-2 mt-6 mt-lg-0">
                        <div class="card card-span h-100">
                            <div class="card-span-img">
                                <img class="fs-4 text-info" src="./assets/img/icons/sanitasi_layak.png" alt="Icon" width="50" />
                            </div>
                            <div class="card-body pt-6 pb-4">
                                <h4 class="mb-2"><?php echo $jmlsanitasi ?></h4>
                                <h6 class="fs--1">Jumlah KK<br>Sanitasi Layak</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 mt-6 mt-lg-0">
                        <div class="card card-span h-100">
                            ...
                            <div class="card-body pt-6 pb-4">
                                <h4 class="mb-2"><?php echo $jmlbabs ?></h4>
                                <h6 class="fs--1">Jumlah KK Buang Air Besar Sembarangan</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 mt-6 mt-lg-0">
                        <div class="card card-span h-100">
                            ...
                            <div class="card-body pt-6 pb-4">
                                <h4 class="mb-2"><?php echo $jmlsr ?></h4>
                    ...
                    <div class="col-lg-2 mt-6 mt-lg-0">
                        <div class="card card-span h-100">
                            ...
                            <div class="card-body pt-6 pb-4">
                                <h4 class="mb-2"><?php echo $jmlpdam ?></h4>
                                <h6 class="fs--1">Jumlah KK<br>Saluran Air PDAM</h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row flex-center mt-4">
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="dispendik/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/dispendik.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="dispendik/home.html" target="_blank">Dinas Pendidikan</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="dinsos/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/dinsos.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="dinsos/home.html" target="_blank">Dinas Sosial</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2 col-xxl-2 mb-3">
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="disperta/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/disperta.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="disperta/home.html" target="_blank">Dinas Pertanian</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2 col-xxl-2 mb-3">
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="ciptakarya/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/ciptakarya.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="ciptakarya/home.html" target="_blank">Cipta Karya</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="bpbd/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/bpbd.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="bpbd/home.html" target="_blank">BPBD</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="dp3akb/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/dp3akb.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="dp3akb/home.html" target="_blank">DP3AKB</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="dispar/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/pariwisata.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="dispar/home.html" target="_blank">Dinas Pariwisata</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="bpkad/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/aset.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="bpkad/home.html" target="_blank">BPKAD</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-6 col-md-4 col-lg-2 col-xxl-2 mb-3">
                        <div class="card card-span h-100">
                            <div class="card-body pt-4 pb-4">
                                <div class="p-0 h-100"><a href="disnaker/home.html" target="_blank"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/favicons/aset.png" alt="" width="100" /></a>
                                    <h6 class="mb-1"><a href="disnaker/home.html" target="_blank">Dinas Tenaga Kerja</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <iframe src="https://j-tourism.jemberkab.go.id/jtourism-frame/pokdarwis.html" width="100%" height="360" target="_parent" frameborder="0" allowfullscreen></iframe>
