...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM dispemasdes");
            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM dispemasdes GROUP BY tahun DESC");
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-calendar'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama = mysqli_query($dbconn, "SELECT id_kecamatan,kecamatan FROM tbl_dispenduk_area GROUP BY id_kecamatan ORDER BY kecamatan ASC");
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $submenu = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM dispemasdes WHERE id_kecamatan = '" . $idkec . "' ORDER BY tahun DESC");
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Dinas Pemberdayaan Masyarakat dan Desa <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Dinas Pemberdayaan Masyarakat dan Desa <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-0">
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">RT</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahRT"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahRT"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">RW</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahRW"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahRW"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kasipem</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahkasipem"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahkasipem"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kasi Kesejahteraan</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahkasikes"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahkasikes"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kasi Pelayanan</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahkasipel"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahkasipel"></div>
                                        </div>
                                        <div class="col-2 border-200">
                                            <h6 class="pb-1 text-700">Kasun / Kaling</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahkasun"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahkasun"></div>
                                        </div>
                                    </div>

                                    <div class="row mt-4 mb-0">
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kepala Desa</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahkepdes"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahkepdes"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Sekretaris Desa</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahsekdes"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahsekdes"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Tata Usaha</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahTU"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahTU"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Keuangan</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahKeuangan"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahKeuangan"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Perencanaan</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahrencana"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahrencana"></div>
                                        </div>
                                        <div class="col-2 border-200">
                                            <h6 class="pb-1 text-700">Anggota BPD</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1" id="lbljumlahBPD"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahBPD"></div>
                                        </div>
                                    </div>

                                    <div class="row mt-4 mb-0">
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kades Tamat SMP</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1 text-danger" id="lbljumlahSMP"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahSMP"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kades Tamat SMA</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1 text-success" id="lbljumlahSMA"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahSMA"></div>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h6 class="pb-1 text-700">Kades Sarjana</h6>
                                            <p class="font-sans-serif lh-1 mb-1 fs-1 text-primary" id="lbljumlahSarjana"></p>
                                            <div class="d-flex align-items-center" id="lblketjumlahSarjana"></div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Kasi - Kasun</p>
                                    </div>
                                    <div class="chart h-100" id="hitungUsahaMikroPie" data-echart-responsive="true">
                                        <canvas id="usahaMikroPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Pegawai Desa</p>
                                    </div>
                                    <div class="chart h-100" id="hitungKondisiKoperasiPie" data-echart-responsive="true">
                                        <canvas id="KondisiKoperasiPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Pendidikan Kepala Desa</p>
                                    </div>
                                    <div class="chart h-100" id="hitungAnggotaPie" data-echart-responsive="true">
                                        <canvas id="AnggotaPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
