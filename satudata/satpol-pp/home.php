...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM satpolpp");
                        ...
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $submenu = mysqli_query($dbconn, "SELECT id_desa,desa FROM tbl_dispenduk_area WHERE id_kecamatan = '" . $idkec . "' ORDER BY desa ASC");
                                    ...
                                    while ($sub = mysqli_fetch_array($submenu)) {
                                        ...
                                        echo " <li class='nav-item'>
                                                    <a class='nav-link lv_desa' href='#!' data-idkec='$idkec' data-id='$iddesa' data-keterangan='desa' data-nmdesa='$nmdesa' data-bs-toggle='' aria-expanded='false'>
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Linmas & Poskamling <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Satuan Polisi Pamong Praja <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-0">
                                        <div class="col-6 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahlinmas"></h4>
                                            <p class="fs--1 text-600 mb-0">Jumlah Linmas</p>
                                        </div>
                                        <div class="col-6 border-200">
                                            <h4 class="mb-0 text-danger" id="lbljumlahposkamling"></h4>
                                            <p class="fs--1 text-600 mb-0">Jumlah Poskamling</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Linmas & Poskamling ( 5 Tahun )</p>
                                    </div>
                                    <div class="chart h-100" id="hitungLinmasChart" data-echart-responsive="true">
                                        <canvas id="LinmasChart" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
