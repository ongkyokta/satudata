...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM kesra");
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM kesra GROUP BY tahun DESC");
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-calendar'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                            ...
                            <li class="nav-item">
                                ...
                                while ($dm = mysqli_fetch_array($menuutama)) {
                                    ...
                                    $submenu = mysqli_query($dbconn, "SELECT id_desa,desa FROM tbl_dispenduk_area WHERE id_kecamatan = '" . $idkec . "' ORDER BY desa DESC");
                                    ...
                                    while ($sub = mysqli_fetch_array($submenu)) {
                                        $iddesa = $sub['id_desa'];
                                        $nmdesa = ucwords(strtolower($sub['desa']));
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Bagian Kesejahteraan Rakyat <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Bagian Kesejahteraan Rakyat <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body bg-light pt-0">
                                    ...
                                    <div class="row mt-3 mb-4">
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahhibah"></h4>
                                            <p class="fs--1 text-600 mb-0">Penerima Hibah</p>
                                        </div>
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-info" id="lbljumlahgurungaji"></h4>
                                            <p class="fs--1 text-600 mb-0">Bansos Guru Ngaji</p>
                                        </div>
                                        <div class="col-4 border-200">
                                            <h4 class="mb-0 text-secondary" id="lbljumlahmudin"></h4>
                                            <p class="fs--1 text-600 mb-0">Bansos P3N (Mudin)</p>
                                        </div>
                                    </div>

                                    <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikkesra" style="height: 6px;">
                                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Penerima Hibah</p>
                                    </div>
                                    <div class="chart h-100" id="hitungHibahPie" data-echart-responsive="true">
                                        <canvas id="hibahPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Penerima Bansos Guru Ngaji</p>
                                    </div>
                                    <div class="chart h-100" id="hitungGuruPie" data-echart-responsive="true">
                                        <canvas id="guruPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Penerima Bansos P3N (Mudin)</p>
                                    </div>
                                    <div class="chart h-100" id="hitungMudinPie" data-echart-responsive="true">
                                        <canvas id="mudinPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
