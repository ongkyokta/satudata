...
date_default_timezone_set('Asia/Jakarta');
	...
	$idoperator = anti_injection(trim($_POST['idoperator']));$idinstansi = anti_injection(trim($_POST['idinstansi']));
	...
	if (trim($idinstansi)=="") {
		$pesanError[] = "Data Instansi operator Tidak Terdeteksi !";		
	}	
	if (trim($nmuser)=="") {
	...
	if (count($pesanError)>=1 ){
		...
		$sql2  = "UPDATE m_operator set nm_operator='$nmuser',username='$username',akses='$akses',id_instansi='$idinstansi' WHERE id_operator='".$idoperator."'";
