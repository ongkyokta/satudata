  ...
  if ($leadConversion) {
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        legend: {
          data: ['Kondisi Baik', 'Rusak Ringan', 'Rusak Sedang', 'Rusak Berat'],
          left: '0%',
          icon: 'circle',
          inactiveColor: utils.getGrays()['400'],
          textStyle: {
        ...
        yAxis: {
          type: 'category',
          data: ['Asrama', 'Tempat Ibadah', 'WC Guru', 'WC Siswa', 'WC Umum', 'Lab Bahasa', 'Lab IPA', 'Komputer', 'Multimedia', 'Ruang Bina','Ruang Guru','Ruang Kepsek','Perpustakaan','Ruang Kelas'],
          axisLine: {
            show: false
          },
          boundaryGap: false,
        ...
        series: [{
          ...
          type: 'bar',
          stack: 'total',
          data: [1405, 1300, 1620, 1430, 1500, 1520, 1520],
          barWidth: '20%'
        }, {
          name: 'Rusak Ringan',
          type: 'bar',
          stack: 'total',
          data: [320, 302, 301, 334, 340, 390, 1520],
          barWidth: '20%'
        }, {
          name: 'Rusak Sedang',
          type: 'bar',
          stack: 'total',
          data: [220, 182, 351, 234, 290, 300, 1520],
          barWidth: '20%'
        }, {
          name: 'Rusak Berat',
          type: 'bar',
          stack: 'total',
          data: [120, 182, 191, 134, 190, 170, 1520],
          barWidth: '20%'
        }],
        grid: {
          right: 5,
