...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM tapem_indikator");
    ...
    <main class="main" id="top">
        <div class="container-fluid" data-layout="container">
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM tapem_indikator GROUP BY tahun DESC");
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-clock'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                </div>
              </a>";
                                }
                                mysqli_free_result($menuutama2);mysqli_close($dbconn);
                                ?>
                            </li>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header d-flex flex-between-center">
                                        <h6 class="mb-0">Statistik Data Bagian Tata Pemerintahan <span class="lblkoparea"></span>
                                        </h6>
                                    </div>
                                    <div class="card-body bg-light pt-0">
                                        ...
                                        <div class="row mt-3 mb-4">
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahkesehatan"></h4>
                                                <p class="fs--1 text-600 mb-0">Kesehatan</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-default" id="lbljumlahpendidikan"></h4>
                                                <p class="fs--1 text-600 mb-0">Pendidikan</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-info" id="lbljumlahsosial"></h4>
                                                <p class="fs--1 text-600 mb-0">Sosial</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-success" id="lbljumlahtrantib"></h4>
                                                <p class="fs--1 text-600 mb-0">Trantibhumlinmas</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-secondary" id="lbljumlahPU"></h4>
                                                <p class="fs--1 text-600 mb-0">Pekerjaan Umum</p>
                                            </div>
                                            <div class="col-2 border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahPR"></h4>
                                                <p class="fs--1 text-600 mb-0">Perumahan Rakyat</p>
                                            </div>
                                        </div>
                                        
                                        <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikKategori" style="height: 6px;">
                                        </div>
                            ...
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Kesehatan</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartKesehatan" data-echart-responsive="true">
                                            <canvas id="kesehatanChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Pendidikan</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPendidikan" data-echart-responsive="true">
                                            <canvas id="pendidikanChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Sosial</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartSosial" data-echart-responsive="true">
                                            <canvas id="sosialChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Trantibhumlinmas</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartTrantibhumlinmas" data-echart-responsive="true">
                                            <canvas id="TrantibhumlinmasChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Pekerjaan Umum</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPU" data-echart-responsive="true">
                                            <canvas id="PUChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Indikator Perumahan Rakyat</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPR" data-echart-responsive="true">
                                            <canvas id="PRChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
