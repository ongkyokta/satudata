...
$sqlx = ("SELECT bulan AS nmBulan,tahun AS nmTahun, izin_trayek_perkotaan,izin_trayek_pedesaan
...
while($t=mysqli_fetch_array($resultx)){		
	...
	$row_array['jumkota']= $t['izin_trayek_perkotaan'];
	$row_array['jumdesa']= $t['izin_trayek_pedesaan'];
