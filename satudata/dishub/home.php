            ...
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                ...
                <div class='d-flex align-items-center'><span class='nav-link-icon'><span class='fas fa-calendar'></span></span><span class='nav-link-text ps-1'>$tahun</span>
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama = mysqli_query($dbconn, "SELECT * FROM tbl_dispenduk_area GROUP BY kecamatan ASC");
                                ...
                                while($sub = mysqli_fetch_array($submenu)){
                                        $iddesa = $sub['id_desa'];$nmdesa = ucwords(strtolower($sub['desa']));
                ...
                <div id="area-halaman">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Dinas Perhubungan <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    <div class="card-header d-flex flex-between-center">
                                        <h6 class="mb-0">Statistik Data Dinas Perhubungan <span class="lblkoparea"></span>
                                        </h6>
                                    </div>
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahUjiKIR"></h4>
                                                <p class="fs--1 text-600 mb-0">Uji KIR</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-danger" id="lbljumlahLakaLintas"></h4>
                                                <p class="fs--1 text-600 mb-0">Laka Perlintasan</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-info" id="lbljumlahSarpras"></h4>
                                                <p class="fs--1 text-600 mb-0">Sarana Prasarana</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-success" id="lbljumlahTrayek"></h4>
                                                <p class="fs--1 text-600 mb-0">Perizinan Trayek</p>
                                            </div>
                                            <div class="col-2 border-end border-200">
                                                <h4 class="mb-0 text-secondary" id="lbljumlahPenumpang"></h4>
                                                <p class="fs--1 text-600 mb-0">Penumpang</p>
                                            </div>
                                            <div class="col-2 border-200">
                                                <h4 class="mb-0 text-primary" id="lbljumlahArmada"></h4>
                                                <p class="fs--1 text-600 mb-0">Armada</p>
                                            </div>
                                        </div>
                                        
                                        <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikSarpras" style="height: 6px;">
                                        </div>
                            ...
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Jumlah Kendaraan Uji KIR</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartUjiKIR" data-echart-responsive="true">
                                            <canvas id="ujiKIRChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Kecelakaan Di Perlintasan</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartLakaPerlintasan" data-echart-responsive="true">
                                            <canvas id="LakaPerlintasanChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Jumlah Sarana Prasarana</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartSarpras" data-echart-responsive="true">
                                            <canvas id="SarprasChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Jumlah Perizinan Trayek</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartTrayek" data-echart-responsive="true">
                                            <canvas id="TrayekChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Jumlah Penumpang</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartPenumpang" data-echart-responsive="true">
                                            <canvas id="PenumpangChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 g-3">
                            <div class="col-xxl-6 px-xxl-2">
                                <div class="card bg-line-chart-gradient h-lg-100">
                                    <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                        <div class="col light">
                                            <p class="fs--1 fw-semi-bold">Grafik Jumlah Armada</p>
                                        </div>
                                        <div class="chart h-100" id="hitungChartArmada" data-echart-responsive="true">
                                            <canvas id="ArmadaChart" height="250px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Kecelakaan Perlintasan <span class="lblkoparea"></span>
                                    </h6>
                                </div>
                                <div class="card-body pt-0">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-primary" id="lbljumlahMeninggal"></h4>
                                            <p class="fs--1 text-600 mb-0">Meninggal Dunia</p>
                                        </div>
                                        <div class="col-4 border-end border-200">
                                            <h4 class="mb-0 text-success" id="lbljumlahLukaBerat"></h4>
                                            <p class="fs--1 text-600 mb-0">Luka Berat</p>
                                        </div>
                                        <div class="col-4 border-200">
                                            <h4 class="mb-0 text-danger" id="lbljumlahLukaRingan"></h4>
                                            <p class="fs--1 text-600 mb-0">Luka Ringan</p>
                                        </div>
                                    </div>

                                    <div class="overflow-visible progress mt-5 rounded-3" id="areastatistikLaka" style="height: 6px;">
                                    </div>
                                    <h6 class="fs--1 mb-2 mt-3">Prosentase Tingkat Pertumbuhan <span class="lblkopperbandinganarea"></span></h6>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Jumlah Kecelakaan Perlintasan</p>
                                    </div>
                                    <div class="chart h-100" id="hitungLakaLintasChart" data-echart-responsive="true">
                                        <canvas id="LakaLintasChart" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Total Kecelakaan Perlintasan</p>
                                    </div>
                                    <div class="chart h-100" id="hitungLakaLintasPie" data-echart-responsive="true">
                                        <canvas id="LakaLintasPie" height="250px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
