        ...
        <div class="container-fluid" data-layout="container">
            <nav class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant">
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
              $menuutama = mysqli_query($dbconn, "SELECT * FROM tbl_api_dinsos GROUP BY id_kecamatan ASC");
              while($dm = mysqli_fetch_array($menuutama)){
				...
				$submenu = mysqli_query($dbconn, "SELECT * FROM tbl_api_dinsos WHERE id_kecamatan = '".$idkec."' GROUP BY desa ASC");
            ...
            <div class="content">
                ...
                <div id="area-halaman">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <div class="row flex-between-center">
                                <div class="col-auto">
                                    <h6 class="mb-0">Peta Sebaran Penerima Bansos <span id="lblkoppeta"></span></h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data Terpadu Kesejahteraan Sosial (DTKS) <span class="lblkoparea"></span></h6>
                                </div>
                                <div class="card-body pt-0">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahbansos"></h4>
                                            <p class="fs--1 text-600 mb-0">Penerima Bansos</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahbnpt"></h4>
                                            <p class="fs--1 text-600 mb-0">Bansos BNPT</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahpkh"></h4>
                                            <p class="fs--1 text-600 mb-0">Bansos PKH</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahppkm"></h4>
                                            <p class="fs--1 text-600 mb-0">Bansos PPKM</p>
                                        </div>
                                        <div class="col-2 border-end border-200">
                                            <h4 class="mb-0" id="lbljumlahjkn"></h4>
                                            <p class="fs--1 text-600 mb-0">JKN</p>
                                        </div>
                                    </div>
                                    ...
                                    <p class="fs--1 mb-2 mt-3">Prosentase jumlah penduduk yang mendapatkan bansos  <span class="lblkoparea"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 g-3">
                        <div class="col-lg-8 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Penduduk Mendapatkan Bansos</p>
                                    </div>
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="card bg-line-chart-gradient h-lg-100">
                                <div class="card-body text-white d-flex flex-column justify-content-between h-100 pe-3">
                                    <div class="col light">
                                        <p class="fs--1 fw-semi-bold">Grafik Perbandingan Penduduk</p>
                                    </div>
                    ...
                    <!---------------- tabel DTKS ------------------>
<div class="row mb-3 mt-3 g-3" id="area-tabel-dtks" style="display:none">
            ...
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center pe-0">
                        <h6 class="mb-0 text-nowrap py-2 py-xl-0">Tabel Data Terpadu Kesejahteraan Sosial (DTKS)  <span class="lblkoparea"></span></h6>
                    </div>
                </div>
            </div>
                    ...
                    <table id="tabeljadwal" class="table table-striped table-sm mb-0 fs--1 w-100">
                        <thead class="bg-200">
                            <tr>
                                ...
                                <th class="sort text-center">Nama Wilayah</th>
                                <th class="sort text-center text-primary">Penduduk</th>
                                <th class="sort text-center">BNPT</th>
                                <th class="sort text-center">PKH</th>
                                <th class="sort text-center">PPKM</th>
                                <th class="sort text-center">JKN</th>
                                <th class="sort text-center text-primary">Bansos</th>
                            </tr>
                        </thead>
...
<!---------------- akhir jadwal ------------------>
                   ...
                   <!---------------- tabel PEKERJAAN DTKS ------------------>
                   <div class="row mb-3 mt-3 g-3" id="area-tabel-pekerjaan">
    <div class="col-xxl-12">
        ...
        <div class="card z-index-1 mb-3">
            <div class="card-header">
                <div class="row flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center pe-0">
                        <h6 class="mb-0 text-nowrap py-2 py-xl-0">Tabel DTKS Kategori Pekerjaan <span class="lblkoparea"></span></h6>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body bg-light px-3 py-3">
                <div class="table-responsive scrollbar">
                    <table id="tabelpekerjaan" class="table table-striped table-sm mb-0 fs--1 w-100">
                        <thead class="bg-200">
                            <tr>
                                <th class="sort text-center">No</th>
                                <th class="sort text-center">Pekerjaan</th>
                                <th class="sort text-center">BNPT</th>
                                <th class="sort text-center">PKH</th>
                                <th class="sort text-center">PPKM</th>
                                <th class="sort text-center">JKN</th>
                        ...
                        <tbody class="bg-white" id="isitabelpekerjaan"></tbody>
                    </table>
                </div>
            </div>
                        ...
                        <div class="col-xxl-6 px-xxl-2">
                            <div class="card h-100">
                                <div class="card-header bg-light">
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h6 class="mb-0">Grafik Bansos PKH Berdasarkan Pekerjaan <span id="lblkopgrafik2"></span></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body h-100">
                                    <div class="chart h-100" id="hitungChartContentPKH" data-echart-responsive="true">
                                        <canvas id="hitungChartPKH" style="height:400px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 px-xxl-2">
                            <div class="card h-100">
                                <div class="card-header bg-light">
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h6 class="mb-0">Grafik Bansos PPKM Berdasarkan Pekerjaan <span id="lblkopgrafik2"></span></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body h-100">
                                    <div class="chart h-100" id="hitungChartContentPPKM" data-echart-responsive="true">
                                        <canvas id="hitungChartPPKM" style="height:400px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 px-xxl-2">
                            <div class="card h-100">
                                <div class="card-header bg-light">
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h6 class="mb-0">Grafik Bansos JKN Berdasarkan Pekerjaan <span id="lblkopgrafik2"></span></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body h-100">
                                    <div class="chart h-100" id="hitungChartContentJKN" data-echart-responsive="true">
                                        <canvas id="hitungChartJKN" style="height:400px"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 px-xxl-2">
                            <div class="card h-100">
                                <div class="card-header bg-light">
                                    <div class="row flex-between-center">
                                        <div class="col-auto">
                                            <h6 class="mb-0">Grafik Status Akreditasi Sekolah <span
                                                    id="lblkopgrafik4"></span></h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body h-100">
