...
$sqlx = ("SELECT DISTINCT id_kecamatan,kecamatan FROM tbl_api_dinsos");
$result = mysqli_query($dbconn,$sqlx);
$data = array();
$no=0;
while($t=mysqli_fetch_array($result)){
	
	$sqlx3 = ("SELECT SUM(jml_penduduk) AS jmlpenduduk FROM tbl_api_dispenduk_kecamatan WHERE id_kecamatan='".$t['id_kecamatan']."'");
	...
	FROM tbl_api_dinsos WHERE id_kecamatan='".$t['id_kecamatan']."'");
