...
$jsondata = file_get_contents('dispendukdesa.json');
...
foreach($array as $row) {
  ...
  //$kecamatan = $row['Kecamatan'];$jmlpenduduk = $row['Jumlah_Penduduk'];
              ...
              $sql2  = "INSERT INTO tbl_api_dispenduk_desa (desa,kecamatan,jml_penduduk) 
                  VALUES ('".$row['Desa_Kelurahan']."','".$row['Kecamatan']."','".$row['Jumlah_Penduduk']."')";
