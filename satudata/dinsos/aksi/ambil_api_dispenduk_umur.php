...
$qri="TRUNCATE TABLE tbl_api_dispenduk_umur";	
$resqri=mysqli_query($dbconn,$qri);

$jsondata = file_get_contents('dispendukumur.json');
...
foreach($array as $row) {
  ...
  //$kecamatan = $row['Kecamatan'];$jmlpenduduk = $row['Jumlah_Penduduk'];
              ...
              $sql2  = "INSERT INTO tbl_api_dispenduk_umur (umur,jumlah) 
                  VALUES ('".$row['Rentang_Umur']."','".$row['Jumlah']."')";
