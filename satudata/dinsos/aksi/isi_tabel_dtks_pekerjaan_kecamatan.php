...
$sqlx = ("SELECT DISTINCT (pekerjaan) AS nmpekerjaan FROM tbl_api_dinsos WHERE id_kecamatan='".$idkecamatan."'");
...
while($t=mysqli_fetch_array($result)){
	...
	FROM tbl_api_dinsos WHERE pekerjaan='".$t['nmpekerjaan']."' AND id_kecamatan='".$idkecamatan."'");
