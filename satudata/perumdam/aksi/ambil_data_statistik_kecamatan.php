...
$sqlcus = ("SELECT SUM(IF(tahun='".$tahun."' AND id_kecamatan='".$idarea."',jml_pelanggan,0)) AS JumCus,SUM(IF(tahun='".$thnsebelumnya."' AND id_kecamatan='".$idarea."',jml_pelanggan,0)) AS JumCusT,
		SUM(IF(tahun='".$tahun."' AND id_kecamatan='".$idarea."',air_terjual,0)) AS JumJual,SUM(IF(tahun='".$thnsebelumnya."' AND id_kecamatan='".$idarea."',air_terjual,0)) AS JumJualT
