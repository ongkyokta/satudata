...
$qrithnakhir = ("SELECT MAX(tahun) AS thnakhir FROM rsd_dr_soebandi");
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <?php
                                $menuutama2 = mysqli_query($dbconn, "SELECT DISTINCT tahun FROM rsd_dr_soebandi GROUP BY tahun DESC");
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-header d-flex flex-between-center">
                                    <h6 class="mb-0">Statistik Data RSUD Dr. Soebandi</h6>
                                </div>
