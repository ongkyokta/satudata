  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      for (i = 0; i < data.length; i++) {
        ...
        var jmlfarmasi = formatRibuan(data[i].jmlfarmasi);
        var jmls1psikologi = formatRibuan(data[i].jmls1psikologi);
        ...
        var jmlteknis = formatRibuan(data[i].jmlteknis);
        var jmlstruktural = formatRibuan(data[i].jmlstruktural);
      ...
      html +=
        ...
        '<td class="align-middle" width="10%">Teknis Kefarmasian</td>' +
        '<td class="align-middle text-center" width="10%">' + tahun + '</td>' +
        '<td class="align-middle text-center" width="10%">' + jmlfarmasi + '</td>' +
        '</tr>' +
        '<tr class="btn-reveal-trigger">' +
        '<td class="align-middle text-center" width="3%">8</td>' +
        '<td class="align-middle" width="10%">S1 Psikologi Klinis</td>' +
        '<td class="align-middle text-center" width="10%">' + tahun + '</td>' +
        '<td class="align-middle text-center" width="10%">' + jmls1psikologi + '</td>' +
        '<tr class="btn-reveal-trigger">' +
        ...
        '</tr>' +
        '<tr class="btn-reveal-trigger">' +
        '<td class="align-middle text-center" width="3%">17</td>' +
        '<td class="align-middle" width="10%">Tenaga Teknis Kesehatan</td>' +
        '<td class="align-middle text-center" width="10%">' + tahun + '</td>' +
        '<td class="align-middle text-center" width="10%">' + jmlteknis + '</td>' +
        '</tr>' +
        '<tr class="btn-reveal-trigger">' +
        '<td class="align-middle text-center" width="3%">18</td>' +
        '<td class="align-middle" width="10%">Struktural Manjemen</td>' +
        '<td class="align-middle text-center" width="10%">' + tahun + '</td>' +
        '<td class="align-middle text-center" width="10%">' + jmlstruktural + '</td>' +
        '</tr>' +
        '<tr class="btn-reveal-trigger">' +
        '<td class="align-middle text-center" width="3%">19</td>' +
        '<td class="align-middle" width="10%">Analis Kesehatan</td>' +
        '<td class="align-middle text-center" width="10%">' + tahun + '</td>' +
        '<td class="align-middle text-center" width="10%">' + jmlanalis + '</td>' +
        '</tr>' +
        '<tr class="btn-reveal-trigger">' +
        '<td class="align-middle text-center" width="3%">20</td>' +
