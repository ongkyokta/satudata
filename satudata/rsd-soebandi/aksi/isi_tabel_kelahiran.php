...
//	$row_array['no']=$no;
	...
	$row_array['jmlfarmasi']=$row['jmlfarmasi'];
	$row_array['jmlapoteker']=$row['jmlapoteker'];
	$row_array['jmls1psikologi']=$row['jmls1psikologi'];
	...
	$row_array['jmlteknis']=$row['jmlteknis'];
	$row_array['jmlstruktural']=$row['jmlstruktural'];
